...
Machine-readable result: `.omo/evidence/ticket21/benchmark-initial/m7-performance.json`

| Item | Value |
|---|---|
| Generated (UTC) | 2026-08-12T09:44:17Z |
| macOS | 26.5.2 |
| GPU | Apple M3 Pro |
...
|---|---:|---:|---:|---:|---:|---:|---|---|---|
| lens_reflections | 1920×1080 | 0.00 | 0.00 | 0 B | 0 B | 0 B | FAIL | FAIL | FAIL |

Failure: `Lens Reflections 1920x1080: Metal output was non-finite or unchanged at sampled pixels`
