...
Machine-readable result: `.omo/evidence/ticket21/benchmark-run8/m7-performance.json`

| Item | Value |
|---|---|
| Generated (UTC) | 2026-08-12T09:54:01Z |
| macOS | 26.5.2 |
| GPU | Apple M3 Pro |
| Power / thermal / GPU load | unavailable |
| Bundle | `build/CBEFFilmEffects.ofx.bundle/Contents/MacOS/CBEFFilmEffects.ofx` |
| Bundle SHA-256 | `a4bb3318d5063c8c147177b43b6cfa594a2d36445ac19a152ac7a80924b2e888` |
...
|---|---:|---:|---:|---:|---:|---:|---|---|---|
| lens_reflections | 1920×1080 | 37.91 | 37.88 | 35291136 B | 35291136 B | 0 B | PASS | PASS | PASS |
| lens_reflections | 3840×2160 | 145.20 | 145.36 | 116146176 B | 116146176 B | 0 B | FAIL | PASS | FAIL |
