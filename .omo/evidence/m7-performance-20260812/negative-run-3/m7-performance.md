...
Machine-readable result: `.omo/evidence/m7-performance-20260812/negative-run-3/m7-performance.json`

| Item | Value |
|---|---|
| Generated (UTC) | 2026-08-11T19:33:02Z |
| macOS | 26.5.2 |
| GPU | Apple M3 Pro |
| Bundle | `.omo/evidence/m7-performance-20260812/negative-run-3/missing.ofx` |
